                    ...
                    <dialog ref={dialogRef} className="cookie-dialog">
                        <form method="dialog">
                            ...
                            <p>
                                ...
                                použitím cookies? */}
                                Soubory cookie používáme ke shromažďování a
                                analýze informací o výkonu a používání webu,
                                zajištění fungování funkcí ze sociálních médií a
                                ke zlepšení a přizpůsobení obsahu a reklam.
                            </p>
                            <div className="more">
                                <label
                                    className="mainLabel"
                            ...
                            >
                                ...
                                <label>
                                    ...
                                    ></i>
                                    <p>
                                        Funkční cookies jsou typem cookies,
                                        které zlepšují uživatelský zážitek na
                                        webových stránkách tím, že si pamatují
                                        vaše volby a preference. Například si
                                        mohou zapamatovat váš výběr jazyka,
                                        regionu nebo jiné nastavení, které jste
                                        na webu provedli
                                    </p>
                                </label>
                                <label>
                                    ...
                                    ></i>
                                    <p>
                                        Analytické cookies, také známé jako
                                        statistické cookies, se používají ke
                                        shromažďování informací o tom, jak
                                        návštěvníci používají webové stránky.
                                        Tyto cookies sledují například, které
                                        stránky jsou nejnavštěvovanější, jak
                                        dlouho na nich uživatelé zůstávají, a
                                        jaké funkce používají
                                    </p>
                                </label>
                                <label>
                                    <input
                                    ...
                                    ></i>
                                    <p>
                                        Marketingové cookies se používají k
                                        sledování návštěvníků napříč webovými
                                        stránkami a k vytváření profilů jejich
                                        zájmů. Tyto cookies umožňují zobrazovat
                                        personalizované reklamy, které jsou
                                        relevantní pro jednotlivé uživatele, což
